...
%\td{Introduce the equations here with bottom pressure torque and \gls{JEBAR}? One of the papers does a really good job of justifying this - maybe Greatbatch or Gula? Include some of the Gula or Yeager figures}
...
%TODOSplitting the \gls{JEBAR} term:
...
%TODO\td{Intro about bottom pressure torque as for \gls{JEBAR}}
...
%The bottom pressure torque is important for the separation of the Gulf Stream, it has been shown that the effect of bottom pressure torque with the \gls{DWBC} has a strong impact on the \gls{NRG} and thus the dynamics affecting the Gulf Stream \citep{Zhang2007}.

%The bottom pressure torque is important for the separation of the Gulf Stream as \citep{Zhang2007} showed that the effect of bottom pressure torque with the \gls{DWBC} has a strong impact on the \gls{NRG} and thus the dynamics affecting the Gulf Stream.




%TODO link bottom pressure torque and \gls{JEBAR} - The two terms are linked but represent different effects of the topography.




%\subsubsection*{Bottom Vortex Stretching}
